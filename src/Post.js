          ...
          <div className="card-body">
            <div className="row">
              <div className="col-md-6">
                <h6 className="card-title text-uppercase">{props.job.employer}</h6>
                <h5 className="card-title text-uppercase">
                  <Link to={`/jobs/${props.job.id}`}><strong>{props.job.position}</strong></Link>
                </h5>
              </div>
              ...
              <div className="col-md-3">
                <h6 className="text-muted text-right align-middle">{props.job.location}</h6>
              </div>
            </div>
          </div>
        </div>
